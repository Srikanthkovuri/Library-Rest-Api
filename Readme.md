...
**To get a book**, `http://127.0.0.1:8000/books/2` method:get and clicked on try it
 ...
 ![alt text](getbook.png)

Then, clicked on Execute and got a response as like below

![alt text](getbook1.png)
